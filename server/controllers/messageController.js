...
export const getMessagesWithUser = async (req, res) => {
    ...
    try {
        ...
        const partner = await User.findById(req.params.userId).select("name username profilePhoto headline college");
...
export const sendMessage = async (req, res) => {
    ...
    try {
        ...
        const recipient = await User.findById(req.params.userId).select("name username profilePhoto headline college followers following");
